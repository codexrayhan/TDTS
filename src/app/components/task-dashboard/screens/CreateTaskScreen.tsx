...
export function CreateTaskScreen({ onNavigate }: { onNavigate?: (id: ScreenId) => void }) {
  const { register, handleSubmit, setValue } = useForm<FormValues>({ defaultValues: { title: "", description: "", project: "Project Alpha", priority: "medium", deadline: "2026-09-24", assignee: "ben" } });
